...
```{r polynomialFits, cache=FALSE, echo = FALSE, fig.cap='Mean fit and 95% CI for the different polynomial regressions and bias variance decomposition', out.width='100%', fig.asp=1, fig.align='center', warning=FALSE}
n.sim <- 1e3
