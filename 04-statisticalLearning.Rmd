...
```{r inOutSampleError, cache=FALSE, echo = FALSE, fig.cap='Out-of-sample error vs. degree of polynomial.', out.width='80%', fig.asp=.75, fig.align='center', warning=FALSE, message=FALSE}
library(ggplot2)
cbp1 <- c("#999999", "#E69F00", "#56B4E9", "#009E73",
          "#F0E442", "#0072B2", "#D55E00", "#CC79A7")
...
```{r vcDim1, cache=FALSE, echo = FALSE, fig.cap='Two points can be shattered', out.width='80%', fig.asp=.3, fig.align='center', warning=FALSE}
...
```
```{r vcDim2, cache=FALSE, echo = FALSE, fig.cap='Three points that can not be shattered', out.width='80%', fig.asp=.3, fig.align='center', warning=FALSE}
...
```{r vcDim3, cache=FALSE, echo = FALSE, fig.cap='Three points can be shattered but not four', out.width='80%', fig.asp=.3, fig.align='center', warning=FALSE}
#Dichotomy 1
x1 <- c(-1,0, 1)
x2 <- c(-1,1, -1)
category <- c("-1","1", "1")
...
```{r vcDim4, cache=FALSE, echo = FALSE, fig.cap='A one parameter function can shatter any number of points', out.width='80%', fig.asp=.3, fig.align='center', warning=FALSE}
...
```
```{r radialBasisSVM, cache=FALSE, echo = FALSE, fig.cap='Training data a radial basis SVM classification', out.width='80%', fig.asp=.75, fig.align='center', warning=FALSE, message =FALSE}
library(caret)
...
```{r 4fits, cache=FALSE, echo = TRUE, fig.cap='Polynomial fits to four different sets of training data, sampled from the same distribution', out.width='100%', fig.asp=1, fig.align='center', warning=FALSE}
set.seed(42)
...
```{r polynomialFits, cache=FALSE, echo = FALSE, fig.cap='Mean fit and 95% CI for the different polynomial regressions', out.width='100%', fig.asp=1, fig.align='center', warning=FALSE}
n.sim <- 1e3
...
```{r errorVsDegree, cache=FALSE, echo = TRUE, fig.cap='Bias/Variance decomposition when varying the degree of the polynomial. Left picture with n = 100, right with n = 10000', out.width='80%', fig.asp=.75, fig.align='center', warning=FALSE}
library(ggplot2)
library(gridExtra)
...
```{r, echo = TRUE, cache = FALSE, message=FALSE, error = FALSE}
...
```{r lassoPlot, cache=FALSE, echo = TRUE, fig.cap='Cross-validated error against the regularization parameter for Lasso.', out.width='80%', fig.asp=.75, fig.align='center', warning=FALSE}
plot(lasso)
```
...
```
```{r elasticNetPlot, cache=FALSE, echo = TRUE, fig.cap='Cross-validated error against the regularization parameter for elastic net', out.width='80%', fig.asp=.75, fig.align='center', warning=FALSE}
plot(e.net)
```
```{r echo =TRUE}
...
```{r SVMApplicationPlot, cache=FALSE, echo = TRUE, fig.cap='Cross-validated accuracy against the regularization parameter for the SVM', out.width='80%', fig.asp=.75, fig.align='center', warning=FALSE}
plot(model)
```
