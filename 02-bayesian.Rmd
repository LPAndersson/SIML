...
```{r gammaDist, cache=FALSE, echo = FALSE, fig.cap='Density of the gamma distribution', out.width='80%', fig.asp=.75, fig.align='center'}
library(ggplot2)
library(latex2exp)
...
```{r gammaDistPostSubj, cache=FALSE, echo = FALSE, fig.cap='Density of the posterior distribution when prior is subjective', out.width='80%', fig.asp=.75, fig.align='center'}
library(ggplot2)
library(latex2exp)
...
```{r gammaDistPostFlat, cache=FALSE, echo = FALSE, fig.cap='Density of the posterior distribution when prior is flat', out.width='80%', fig.asp=.75, fig.align='center'}
library(ggplot2)
library(latex2exp)
