...
```{r wageDataPlot, cache = TRUE, echo = TRUE, fig.cap='Scatter plot matrix of wage data.', out.width='80%', fig.asp=.75, fig.align='center', warning=FALSE}
library(ISLR)
library(gam)
library(GGally)
...
```{r mnistHistory, cache = TRUE, echo = FALSE, fig.cap='Training and validation loss/accuracy for each epoch', out.width='80%', fig.asp=.75, fig.align='center', warning=FALSE}
plot(history) +
  theme_minimal()
```
