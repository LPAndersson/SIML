...
$$
```
```{r empiricalDistrFcnExample, echo = TRUE, tidy=FALSE, cache=FALSE, message=FALSE, fig.cap = "Empirical distribution function", out.width='80%', fig.asp=.75, fig.align='center'}
